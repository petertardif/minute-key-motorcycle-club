<template>
  <v-container fluid>
    <v-row justify="center" dense>
      <v-col v-for="bike in bikes" :key="bike.model" :cols="bike.flex">
        <bike
          :key="bike.model"
...
export default {
    ...
    bikes: [
      {
        ...
        displacement: "821 cc",
        year: "2020",
        src: "../src/assets/Monster_821_Stealth.jpg",
        flex: 5,
        isFavorite: true,
      },
      {
      ...
      },
      {
        ...
        year: "2020",
        src: "../src/assets/Bobber_Scout.jpg",
        flex: 5,
        isFavorite: true,
      },
      {
        ...
        year: "2020",
        src: "../src/assets/Panigale_V4.jpg",
        flex: 5,
        isFavorite: false,
      },
    ],
  ...
  methods: {
    toggleFavoriteStatus(bikeModel) {
      const identifiedBike = this.bikes.find(
        (bike) => bike.model === bikeModel
      );
